...
A **VST audio plugin** built with [JUCE](https://juce.com), for dynamic filter modulation.
...
### Modulation Sources
#### Sequencer
- Up to **16 discrete cutoff steps**  
- For rhythmic or step-based filter patterns  
